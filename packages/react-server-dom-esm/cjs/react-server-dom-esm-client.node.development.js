...
function createFromNodeStream(stream, moduleRootPath, moduleBaseURL) // TODO: Used for preloading hints
{
  var response = createResponse(moduleRootPath, noServerCall);
