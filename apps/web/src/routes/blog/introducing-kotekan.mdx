...
Today, I'm excited to release the first version of Kotekan, a modern React framework built on Bun. Please note that this is highly experimental at this stage. I'm grateful for everyone who dares to try it and am looking forward to constructive feedback. I'd not recommend using this for any production workloas at this stage.

If you want to try it out, you can simply create a new project by running:
